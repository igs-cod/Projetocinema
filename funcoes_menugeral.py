...
from funcoes_usu import menu_cliente
from funcoes_adm import menu_adm
...
def login_cadas_us():
    ...
    # falta validar pra n deixar passar
...
def menu_geral ():
    while True:
        escolha = input('|=============== \033[94mMENU GERAL \033[0m ==================\n'
                        ...
                        '|  \033[93;1m  5- Listar ADMs cadastrados \033[0m  \n'
                        '|  \033[93;1m  6- Listar clientes cadastrados \033[0m  \n'
                        '| --------------------------------------------\n'

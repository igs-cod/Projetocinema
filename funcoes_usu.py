...
def comprar_ingressos():
    ...
    for fil in list_filmes:
        if fil['titulo'] == ingres:
            ...
            while len(rg) < 5:
                print('rg tem que ser maior que 5 numeros')
                rg = int(input('digite seu rg correto '))
            ...
            regis_ing_cli = {'identidade': rg, 'nome': nome_cli, 'ingresso': ingres, 'quantidade': qt_ing}
...
def busc_fil_p_gen():
    busc_gen = input('qual genero de filmes vc quer pesquisar')
